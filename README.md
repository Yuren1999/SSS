...
当前已完成 `P0 工程骨架`、`P1 数据模型与接口`、`P2 本地谱线数据库`、`P3 HAPI 下载`、`P4 单气体合成`、`P5 混合气体与扰动模型`、`P6 基础批量合成与导出` 和 `P7 GUI 独立页面接入第一版`，已包含：
...
当前阶段不包含完整批量导出 GUI、结果浏览 GUI、HDF5/Parquet 导出和安装包封装。
